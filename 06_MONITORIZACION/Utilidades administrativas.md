...
- 🎯 *Debate:*
     ...
     **Situación**: Imagina que eres el encargado de administrar un servidor que empieza a funcionar muy lento.
     Tienes dos formas de averiguar qué    ocurre:
    ...
    **Pregunta para debatir:** ¿Qué opción crees que es mejor para descubrir por qué va lento el servidor, 
      la A (comandos de texto) o la B (interfaz gráfica)? ¿Por qué?
