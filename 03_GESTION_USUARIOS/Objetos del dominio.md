# OBJETOS DEL DOMINIO (AD DS)

## 1. Cuentas de usuario, grupos y unidades organizativas (OU)
- Organizar los objetos del dominio en contenedores (OU).
...
- 🎯 *Debate: Una empresa está organizada en dos departamentos:
              ...
              Los usuarios del departamento de Jefes, necesitan acceder todos los días a las impresoras en color de las que dispone la empresa.
  
              Los usuarios del departamento de Curritos, no deben poder acceder a las impresoras en color.
  
              a) ¿Qué grupos de usuarios se deben crear (especificando el tipo y el ámbito del grupo)?
  
              b) Explica brevemente por qué has elegido esos grupos y como los has organizado (si hay algún grupo que es miembro de otro grupo, si creas unidades organizativas, etc.)?*
